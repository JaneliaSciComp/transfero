...
def test_transfero(do_transfer_data_from_rigs=True, do_run_analysis=True) :
    ...
    rig_host_name = 'flybubble-ww1.hhmi.org' 
    rig_user_name = 'labadmin' 
    rig_data_folder_path = '/cygdrive/d/flydisco_data/scicompsoft' 
    ...
    per_lab_configuration['user_name_for_configuration_purposes'] = 'rubinlab'
